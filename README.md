...
-   Dots: [`caelestia`](https://github.com/ARP1208)

## Installation

> [!NOTE]
> This repo is for the desktop shell of the caelestia dots. If you want installation instructions
> for the entire dots, head to [the main repo](https://github.com/ARP1208/caelestia) instead.
...
-   [`caelestia-cli`](https://github.com/ARP1208/cli)
...
git clone https://github.com/ARP1208/shell.git caelestia
...
Otherwise, [this file](https://github.com/ARP1208/caelestia/blob/main/hypr/hyprland/keybinds.conf#L1-L39)
...
See the [manual installation](https://github.com/ARP1208/shell?tab=readme-ov-file#manual-installation) section
for the corresponding repo.

### I want to disable XXX feature!

Please read the [configuring](https://github.com/ARP1208/shell?tab=readme-ov-file#configuring) section in the readme.
